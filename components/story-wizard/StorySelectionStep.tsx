...
export function StorySelectionStep({
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-10">
            ...
            >
                <p className="text-[11px] font-extrabold uppercase tracking-[0.22em] text-[var(--play-primary)] mb-3">{siteContent.storySelection.eyebrow}</p>
                <h2 className="play-title text-3xl md:text-4xl mb-2">
                    {siteContent.storySelection.title}
                </h2>
                <p className="play-copy">
                    {siteContent.storySelection.copy}
                </p>
            </motion.div>
                            ...
                            <div className="p-6 flex flex-col h-full relative z-10">
                                <div className="flex items-start gap-5">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {storyMock ? (
                                            <p className="mb-3 text-[11px] font-semibold text-[var(--play-text-muted)]">
                                                {storyMock.mockLabel}. {siteContent.storySelection.mockNote}
                                            </p>
                                        ) : null}
