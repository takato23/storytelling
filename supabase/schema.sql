...
values
  ('1', 'el-explorador-espacial', 'El Explorador Espacial', '4-8 años', '/stories/space-1.jpg', 'Viaja por las estrellas en una aventura intergaláctica.', 'Aventura espacial personalizada para niños.', 29.99, null, 9990, 29990, 'niño', '{"format":"tapa blanda","size":"21 x 21 cm","pages":32,"paper":"satinado a color"}'::jsonb, true),
  ('2', 'el-bosque-magico', 'El Reino del Bosque Mágico', '3-7 años', '/stories/forest-1.jpg', 'Descubre hadas y criaturas fantásticas.', 'Aventura mágica en la naturaleza personalizada para niños.', 29.99, null, 9990, 29990, 'niña', '{"format":"tapa blanda","size":"21 x 21 cm","pages":32,"paper":"satinado a color"}'::jsonb, true),
  ('3', 'valentin-y-la-noche-de-los-dinosaurios', 'Valentín y la noche de los dinosaurios', '3-6 años', '/stories/valentin-noche-dinosaurios/cover.png', 'Un cuento tierno para acompañar el miedo a dormir solo.', 'A veces, cuando llega la noche, todo se siente más silencioso y un poquito más difícil. Junto a su amigo Dino, Valentín descubre que ser valiente no es dejar de sentir miedo, sino animarse incluso cuando el miedo está.', 29.99, null, 9990, 29990, 'niño', '{"format":"Tapa dura","size":"21 x 21 cm","pages":20,"paper":"Satinado color"}'::jsonb, true),
  ('4', 'la-estrella-del-futbol', 'La Estrella del Fútbol', '5-10 años', '/stories/soccer-1.jpg', 'Marca el gol de la victoria en el gran estadio.', 'Historia deportiva personalizada para pequeños campeones.', 29.99, null, 9990, 29990, 'unisex', '{"format":"tapa blanda","size":"21 x 21 cm","pages":32,"paper":"satinado a color"}'::jsonb, true),
  ('5', 'el-castillo-en-las-nubes', 'El Castillo en las Nubes', '4-9 años', '/stories/castle-1.jpg', 'Sube por el tallo de frijoles a un mundo de gigantes amables.', 'Historia fantástica sobre imaginación y valentía.', 29.99, null, 9990, 29990, 'niña', '{"format":"tapa blanda","size":"21 x 21 cm","pages":32,"paper":"satinado a color"}'::jsonb, true)
